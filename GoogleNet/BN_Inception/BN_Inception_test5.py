...
def bn_inception_cifar_model(input, labelDim, bnTimeConst):
    # 32 x 32 x 3
    conv1a = conv_bn_relu_layer(input, 64, (3,3), (1,1), True, bnTimeConst)
    # 32 x 32 x 64
    conv1b = conv_bn_relu_layer(conv1a, 64, (3,3), (1,1), True, bnTimeConst)
    # 32 x 32 x 64
    ...
    # 32 x 32 x 128
    conv3a = conv_bn_relu_layer(conv2b, 128, (3,3), (1,1), True, bnTimeConst)
    # 32 x 32 x 128
    conv3b = conv_bn_relu_layer(conv3a, 128, (3,3), (1,1), True, bnTimeConst)
    # 32 x 32 x 128
    conv3c = conv_bn_relu_layer(conv3b, 160, (3,3), (1,1), True, bnTimeConst)

    # Inception Blocks
    # 32 x 32 x 128
    inception4a = inception_block_pass_through(conv3c, 0, 32, 64,32, 64, 0, bnTimeConst)
    # 16 x 16 x 256
    inception4b = inception_block_with_avgpool(inception4a, 128, 64, 128, 64, 128, 128, bnTimeConst)
    # 16 x 16 x 256
    inception4c = inception_block_with_avgpool(inception4b, 48, 64, 96, 80, 96, 64, bnTimeConst)
    # 16 x 16 x 512
    inception4d = inception_block_pass_through(inception4c, 0, 64, 128, 64, 128, 0, bnTimeConst)
    
    # Global Average
    # 8 x 8 x 512
    pool1 = AveragePooling(filter_shape=(8,8))(inception4c)
