...
from Inception_ResNet_v1_test1 import InceptionV4_ResNet_model
...
log_dir = None
model_name = "Inception_ResNet_v1_test1.model"
...
def create_bn_inception():
    ...
    bn_time_const = 4096
    z = InceptionV4_ResNet_model(feature_var, NUM_CLASSES)
