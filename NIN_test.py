    ...
    with C.layers.default_options ():
        z = C.layers.Sequential([
            C.layers.For(range(1), lambda : [
                C.layers.Convolution2D((3,3), 64, strides = (1,1), pad = True),
                C.layers.Activation(activation = C.relu),
                C.layers.Convolution2D((1,1), 192, strides = (1,1), pad = False),
                C.layers.Activation(activation = C.relu),
                C.layers.Convolution2D((1,1), 160, strides = (1,1), pad = False),
                C.layers.Activation(activation = C.relu),
            ...
            C.layers.For(range(1), lambda : [
                ...
                C.layers.Activation(activation = C.relu),
                C.layers.Convolution2D((1,1),128, strides = (1,1), pad = False),
                C.layers.Activation(activation = C.relu),
