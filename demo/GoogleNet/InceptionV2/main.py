...
from Inception import bn_inception_cifar_model, inceptionv1_cifar_model2
from Inceptionv2_test1 import bn_inceptionv2_cifar_model
...
def create_bn_inception():
    ...
    #z = inceptionv1_cifar_model2(feature_var, NUM_CLASSES, bn_time_const)
    z = bn_inceptionv2_cifar_model(feature_var, NUM_CLASSES, bn_time_const)
...
def create_trainer(network, epoch_size, num_epochs, minibatch_size, progress_writers):
    ...
    initial_learning_rate = 0.01 # equal to 0.2 in caffe
