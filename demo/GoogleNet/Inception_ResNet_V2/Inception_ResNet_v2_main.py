...
from Inception_ResNet_v2_test1 import Inception_ResNet_v2_model
...
log_dir = None
model_name = "Inception_ResNet_v2_test1.model"
...
def create_bn_inception():
    ...
    bn_time_const = 4096
    z = Inception_ResNet_v2_model(feature_var, NUM_CLASSES)
