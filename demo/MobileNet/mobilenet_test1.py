...
def create_cifar10_model(input, num_stack_layers, num_classes):
    ...
    r1 = mobilenet_basic_stack(conv, num_stack_layers, c_map[0])

    r2_1 = mobilenet_basic_inc(r1, c_map[1])
    r2_2 = mobilenet_basic_stack(r2_1, num_stack_layers-1, c_map[1])

    r3_1 = mobilenet_basic_inc(r2_2, c_map[2])
    r3_2 = mobilenet_basic_stack(r3_1, num_stack_layers-1, c_map[2])
